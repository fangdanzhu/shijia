            ...
            <div className="shopcartList">
                <ul>
                    {goodsList.map((item, index) => {
                        return <ShopItem item={item} key={index} isEdit={isEdit} fn={this.updataShopcart}
                                         checked={this.checked}/>
                    })}
                </ul>
                <div className="shopcartSum">
                    <form><Checkbox onChange={this.allSelect} ref="all" checked={all ? true : false}>全选/不全选 </Checkbox>
                    </form>
                    <div>
